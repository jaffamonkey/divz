...
const lines = [
    ...
    "Scroll through our photos and videos of Spanish stuff. Every few weeks we add a few more we found on Google.",
    "Web galleries may be dull, but what the hell - we can't be bothered to do too much thinking.",
    "A magical movie that will never get made because we both already shitting money out of our arses.",
    "Dine on the galleries, or allow the juice Instagram to run down your contented chin"
];
