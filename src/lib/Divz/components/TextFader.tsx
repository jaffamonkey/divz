...
const lines = [
    ...
    "Web galleries may be dull, but what the hell - we simply have no urgency at all.",
    "A magical movie that will never get made because we are both already shitting money out of our arses.",
